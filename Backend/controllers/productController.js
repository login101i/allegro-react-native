...
exports.getUserFavouriteProducts = catchAsynchErrors(async (req, res, next) => {
...
// Create addFavouriteProduct   =>   /api/addFavouriteProduct

exports.addFavouriteProduct = catchAsynchErrors(async (req, res, next) => {
	...
	if (favouriteProducts.includes(productId)) {
		const newFavouriteProduct = favouriteProducts.filter(product => product !== productId);
		user.favouriteProducts = newFavouriteProduct;
		feedback = 'Usunięto produkt z obserwowanych';
	} else {
		favouriteProducts.push(productId);
		user.favouriteProducts = favouriteProducts;
		feedback = 'Dodano produkt do obserwowanych';
	}
